...
public class DateUtils {
     ...
     *
     * @param date1str the first date, not altered, not null
     * @param date2str the second date, not altered, not null
     * @return true if the first date day is before the second date day.
     * @throws IllegalArgumentException if the date is <code>null</code>
     */
    public static boolean isBeforeDay(String date1str, String date2str) {
        if (StringUtils.isNullOrEmpty(date1str) || StringUtils.isNullOrEmpty(date2str)) {
            throw new IllegalArgumentException("The dates must not be null");
        }
        try {
...
//            return null;
    ...
    public static boolean isBeforeDay(Date date1, Date date2) {
        ...
        if (date1.compareTo(date2) == 0) //0 comes when two date are same
            return true;
        else if (date1.compareTo(date2) == 1) //1 comes when date1 is higher then date2
            return false;
        else if (date1.compareTo(date2) == -1) //1 -1 comes when date1 is lower then date2
            return true;
        return false;
    }
