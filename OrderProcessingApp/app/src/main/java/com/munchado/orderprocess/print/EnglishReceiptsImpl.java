...
public class EnglishReceiptsImpl extends ILocalizeReceipts {
    ...
    @Override
    public void append2inchTextReceiptData(ICommandBuilder builder,String printdata, boolean utf8) {
        Charset encoding;
...
//        builder.appendFontStyle(ICommandBuilder.FontStyleType.B);
        ...
        builder.append(printdata.getBytes(encoding));
...
//        builder.appendBarcode(("{BStar.").getBytes(Charset.forName("US-ASCII")), BarcodeSymbology.Code128, BarcodeWidth.Mode2, 40, true);
        builder.appendAlignment(AlignmentPosition.Center);
        builder.appendQrCode(("www.munchado.com").getBytes(Charset.forName("US-ASCII")), ICommandBuilder.QrCodeModel.No1, ICommandBuilder.QrCodeLevel.L,20);
    }
